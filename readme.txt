...
There is an interface built in the plugin to add your own Emojis. Go to Settings > CIA Emoji Time to do that. Add one string per line, without any HTML code.
